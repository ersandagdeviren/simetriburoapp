...
# Read Excel File
df = pd.read_excel(r'C:\Users\MALIHP\Desktop\simetriburoapp\Simetri\order\static\InventoryUpdate.xls')
count = 0
...
for index, row in df.iterrows():
    ...
    for product_instance in product_instances:
        ...
        if not created:
            ...
            inventory_instance.quantity += row['quantity']  # Add the quantity to the existing amount
